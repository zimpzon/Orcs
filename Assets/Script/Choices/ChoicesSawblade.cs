    ...
    static List<Choice> GetUnlockedChoices()
    {
        return new List<Choice>
        {
            ...
            new Choice
            {
                ...
                {
                    Title = $"{Name}, Speed (2)",
                    Description = "<color=#00ff00>-15%</color> time between sawblades",
                    Apply = () =>
                    {
                        PlayerUpgrades.Data.SawBladeCdMul -= 0.15f;
                    },
                    NextLevel = new Choice
                    {
                        Title = $"{Name}, Speed (3)",
                        Description = "<color=#00ff00>-20%</color> time between sawblades",
                        Apply = () =>
                        {
